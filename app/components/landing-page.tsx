...
export const THEMES: Record<string, ThemeConfig> = {
  professional: { name:"缁忓吀鐏?, heroFrom:"from-gray-900", heroVia:"via-gray-800", heroTo:"to-gray-900",
  ...
  ocean: { name:"娴锋磱钃?, heroFrom:"from-blue-900", heroVia:"via-blue-800", heroTo:"to-cyan-900",
